use rustbft_core::{SignedProposal, SignedVote};
use rustbft_core::codec::{
    decode_signed_proposal, decode_signed_vote, encode_signed_proposal, encode_signed_vote,
};
use rustbft_core::error::CodecError;
