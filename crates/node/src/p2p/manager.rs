...
use rustbft_consensus::{ConsensusCommand, ConsensusEvent};
use rustbft_core::{ValidatorId, SignedProposal, SignedVote, VoteType};
...
impl P2pManager {
    ...
    pub async fn run(mut self) -> anyhow::Result<()> {
        ...
        // connect seeds (MVP: connect once; reconnect/backoff will do later)
